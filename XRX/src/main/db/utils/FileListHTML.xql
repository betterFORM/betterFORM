...
<div>
    <style type="text/css">
        ...
        */
        ...
        .bfFormBrowser .formBrowserHeader .pathName{
        ...
        .bfFormBrowser .textLink {
        	display: block;
        	vertical-align: middle;
        }
        
        .bfFormBrowser .directory .textLink {
        	margin-top: 7px;
        }
        
        .bfFormBrowser .file .bfIconFile {
        	margin-top:20px;
        	display:inline-block;
        }
        
        .bfFormBrowser .file .textLink {
        	margin-top: 24px;
        }
        
        .bfFormBrowser .file .sourceLink {
        	position:absolute;
        	top:3px;
        	right:3px;
        	letter-spacing:-2px;
        ...
        .bfFormBrowser  .file .editorLink:hover{
        	font-size:10pt;
        	/*padding:10px;*/
        	width:22px;
        	height:22px;
        ...
        .bfFormBrowser #bfListView .directory,.bfFormBrowser #bfListView .file {
        	clear:left;
        	width:788px;
        	height:24px;
        	text-align:left;
        ...
        .bfFormBrowser #bfListView .file a{
        ...
        .bfFormBrowser  .file .sourceLink:hover{
        	font-size:10pt;
        	/*padding:10px;*/
        	width:22px;
        	height:22px;
        ...
        .bfFormBrowser #bfListView .file .bfIconFile img {
        	width:24px;
        	height:24px;
        }
        .bfFormBrowser .file .bfIconFile{
        ...
        .bfFormBrowser .file .bfIconFile img{
        	width:48px;
        	height:48px;
        }
        .bfFormBrowser .directory a img{
        	width:80px;
        	height:80px;
        }
        .bfFormBrowser #go-up{
    ...
    <div id="mountpoint">
        {fileListing:getHTMLFilesListing($uri, $contextPath, $path, $ajaxFunction, false(), true())}
    </div>
</div>
