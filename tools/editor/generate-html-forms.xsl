<xsl:stylesheet version="2.0"
    ...
    <xsl:template match="/">
        <div>
            <xsl:variable name="title"><xsl:value-of select="//html:title"/></xsl:variable>
            ...
            <div class="propertyDesc"><xsl:value-of select="$dictionary//lang[@id=$lang]/key[@name=$title]/desc"/></div>
