...
--------------------------------------
This is still a semi-automated task. The installer script assumes all pack resouces to be present in subdir
'target'. Exist must be build manually and cannot be downloaded any more amd must be added to the target-dir
