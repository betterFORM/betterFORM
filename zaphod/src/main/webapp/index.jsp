...
<p>This documentation describes how to use <a href="http://www.betterform.de" title="betterForm">betterForm</a> from
    ...
    application context and let <a href="http://www.betterform.de" title="betterForm">betterForm</a> process the form in
    its own context.</p>
...
<ul>
    ...
    <li>The servlet container muss allow to access the context of <a href="http://www.betterform.de" title="betterForm">betterForm</a>.
        ...
        separately. The current distributions of <a href="http://www.betterform.de" title="betterForm">betterForm</a>
        already contain an context.xml
        file which allows other context to access <a href="http://www.betterform.de" title="betterForm">betterForm</a>'s
        context.
    </li>
...
<p>The name of the <a href="http://www.betterform.de" title="betterForm">betterForm</a> context is configured through
...
<p>This file shows a minimal setup. The setup renders all forms in the <code>forms</code>
    directory with the help of <a href="http://www.betterform.de" title="betterForm">betterForm</a> into an html page.
    The setup specifies
    the context in which <a href="http://www.betterform.de" title="betterForm">betterForm</a> is running. Its important
    that the path
