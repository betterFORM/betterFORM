...
public class RequiredCombineTest extends XMLTestBase {
    ...
    public void testReadonlySameParent() throws Exception{
        ...
        assertEquals("true", XPathUtil.evaluateAsString(doc, "//*[@id eq 'a']/bf:data/@required"));
    ...
    public void testrequiredCombination() throws Exception{
        ...
        assertNotNull(bind);
        assertEquals("false() or true()",bind.getRequired());
        assertEquals("true", XPathUtil.evaluateAsString(doc, "//*[@id eq 'b']/bf:data/@required"));
    }
    public void testrequiredMixedCombination() throws Exception{
        ...
        assertEquals("true", XPathUtil.evaluateAsString(doc, "//*[@id eq 'c']/bf:data/@required"));
    }
    ...
    public void testrequiredMixedOneParentCombination() throws Exception{
        ...
        assertNotNull(bind);
        assertEquals("false() or true()",bind.getRequired());
        assertEquals("true", XPathUtil.evaluateAsString(doc, "//*[@id eq 'd']/bf:data/@required"));
    }
