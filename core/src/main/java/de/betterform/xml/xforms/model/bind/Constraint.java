 ...
 */
public class Constraint extends XFormsElement {
    private static final Log LOGGER = LogFactory.getLog(Constraint.class);

    private boolean valid=true;

    public Constraint(Element element, Model model){
        super(element, model);
    }
    ...
    public void setInvalid(){
        this.valid=false;
        this.element.setAttributeNS(null,"valid","false");
    }
