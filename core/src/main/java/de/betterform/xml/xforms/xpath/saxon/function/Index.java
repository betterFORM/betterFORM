...
public class Index extends XFormsFunction
{
	...
	public Item evaluateItem(final XPathContext xpathContext) throws XPathException {
		...
		return index(xpathContext, idref);
	}

	public Sequence call(final XPathContext context,
						 final Sequence[] arguments) throws XPathException {
		final String idref = arguments[0].head().getStringValue();
		return index(context, idref);
	}

	private NumericValue index(final XPathContext context, final String idref) throws XPathException {
