...
public class SchemaReader extends XFormsFunction {
    ...
    */
    ...
    public SequenceIterator iterate(final XPathContext xpathContext) throws XPathException {
        ...
        final String elementName = argument[1].evaluateAsString(xpathContext).toString();

        return schemaReader(xpathContext, namespace, elementName);
    }
    ...
    public Sequence call(final XPathContext context,
        ...
        return SequenceTool.toLazySequence(schemaReader(context, namespace, elementName));
    }

    private SequenceIterator schemaReader(final XPathContext context, final String namespace, final String elementName) throws XPathException {
