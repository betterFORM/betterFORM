...
public class XFormsFunctionLibrary extends XPathFunctionLibrary {
    ...
    static {
        ...
        XPathCache.getNamePool().allocate(NamespaceConstants.XFORMS_PREFIX, NamespaceConstants.XFORMS_NS, "boolean-from-string");
        ...
        arg(e, 0, BuiltInAtomicType.STRING, StaticProperty.EXACTLY_ONE);
        XPathCache.getNamePool().allocate(NamespaceConstants.XFORMS_PREFIX, NamespaceConstants.XFORMS_NS, "is-card-number");
        ...
        XPathCache.getNamePool().allocate(NamespaceConstants.XFORMS_PREFIX, NamespaceConstants.XFORMS_NS, "count-non-empty");

        e = register("{" + NamespaceConstants.XFORMS_NS + "}current", Current.class, 0, 0, 0, Type.ITEM_TYPE, StaticProperty.EXACTLY_ONE);
        XPathCache.getNamePool().allocate(NamespaceConstants.XFORMS_PREFIX, NamespaceConstants.XFORMS_NS, "current");
        ...
        XPathCache.getNamePool().allocate(NamespaceConstants.XFORMS_PREFIX, NamespaceConstants.XFORMS_NS, "IF");

        e = register("{" + NamespaceConstants.XFORMS_NS + "}instance", Instance.class, 0, 0, 1, Type.ITEM_TYPE, StaticProperty.EXACTLY_ONE);
        arg(e, 0, BuiltInAtomicType.STRING, StaticProperty.EXACTLY_ONE);
        XPathCache.getNamePool().allocate(NamespaceConstants.XFORMS_PREFIX, NamespaceConstants.XFORMS_NS, "instance");
