...
public class EventQueue {
    ...
    public void add(XMLEvent event) {
    	try {
	        ...
	        if ((BetterFormEventNames.STATE_CHANGED.equals(clonedEvent.getType()) && HELPER_ELEMENTS.contains(targetName)) || BetterFormEventNames.PROTOTYPE_CLONED.equals(clonedEvent.getType())) {
