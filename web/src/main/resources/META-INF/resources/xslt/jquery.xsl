...
-->
    ...
    <xsl:template match="head">
        ...
        <head>
            ...
            <!--
            >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            CSS needed by Jquery is added here
            ...
            <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
            -->
            <xsl:call-template name="addjQueryUICSS"/>
    ...
    <xsl:template name="addjQueryUICSS"><xsl:text>
</xsl:text><!--
    ...
    <xsl:template match="body">
        ...
        <body class="{$theme} bf {$client-device} {$alert}">
            ...
            >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            -->
            <xsl:call-template name="addjQueryImport"/>
    ...
    <xsl:template name="addjQueryImport">
        <!--
        ...
        <xsl:variable name="jqueryConfig">
		...
		<!-- <script src="{concat($contextroot,$scriptPath,'require.js')}" data-main="{concat($contextroot,$scriptPath, 'js/BetterFORM')}"></script> -->
		<script src="{concat($contextroot,'/js/require.js')}" data-main="{concat($contextroot,'/js/BetterFORM')}"></script>
<xsl:text>
</xsl:text>
	...
	<xsl:template name="addLocalScript">
		<xsl:comment>OLD addLocalScript</xsl:comment>
	</xsl:template>
    <xsl:template name="addLocalScript_old">
